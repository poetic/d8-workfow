...
Webflow.require('ix').init([
  ...
  {"slug":"follow-btn-off","name":"Follow Btn - OFF","value":{"style":{},"triggers":[{"type":"click","stepsA":[{"display":"inline-block"}],"stepsB":[]},{"type":"click","stepsA":[{"display":"none"}],"stepsB":[]}]}},
  {"slug":"follow-btn-on","name":"Follow Btn - ON","value":{"style":{"display":"none"},"triggers":[{"type":"click","stepsA":[{"display":"inline-block"}],"stepsB":[]},{"type":"click","stepsA":[{"display":"none"}],"stepsB":[]}]}},
  {"slug":"fade-in-on-scroll","name":"Fade in on Scroll","value":{"style":{"opacity":0,"x":"0px","y":"20px","z":"0px"},"triggers":[{"type":"scroll","stepsA":[{"wait":250},{"opacity":1,"transition":"transform 300ms ease 0ms, opacity 300ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}}
]);
