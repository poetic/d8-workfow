...
/**
 * @file
 * Contains \Drupal\iframe\Plugin\Field\FieldType\IframeItem
 */
...
class IframeItem extends FieldItemBase {
  ...
  public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    ...
    $element['frameborder'] = array(
      '#type' => 'radios',
      '#title' => t('Frameborder'),
      '#default_value' => $this->getSetting('frameborder'), # '0'
      '#options' => array(
        '0' => t('no frameborder'),
    ...
    $element['scrolling'] = array(
      '#type' => 'radios',
      '#title' => t('Scrolling'),
      '#default_value' => $this->getSetting('scrolling'), # 'auto'
      '#options' => array(
    ...
    $element['transparency'] = array(
      ...
      '#default_value' => $this->getSetting('transparency'), # '0'
      '#options' => array(
        '0' => t('no transparency'),
    ...
    $element['tokensupport'] = array(
      ...
      '#default_value' => $this->getSetting('tokensupport'), # '0'
      '#options' => array(
